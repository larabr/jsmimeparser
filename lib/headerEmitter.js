...
import { kMonthNames, typedArrayToString } from "./utils";

// Get the default structured encoders and add them to the map
import { spellings as preferredSpellings, encoders as headerEncoders} from "./structuredHeaders";
...
*/
  ...
  */
  _addRFC2047Word(
    ...
    let binaryString = typedArrayToString(encodedText);
    let token;
    if (useQP) {
      token = qpPrelude;
