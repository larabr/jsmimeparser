...
import { decode_base64, decode_qp, stringToTypedArray, typedArrayToString } from "./utils";
...
MimeParser.prototype._applyDataConversion = function(buf, type) {
  ...
  return {
    ...
    raw: buf instanceof Uint8Array ? buf : stringToTypedArray(buf)
  };
};
...
MimeParser.prototype._coerceData = function(buffer, type, more) {
  if (typeof buffer == "string") {
    ...
    return typedArrayToString(buffer);
